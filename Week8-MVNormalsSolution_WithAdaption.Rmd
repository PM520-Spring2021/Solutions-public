...
MH-MCMC chains always have some degree of correlation (because you may stay in the sample place in the next iteration), but these look pretty good. Note that if you forget to remove the burn-in period when construcing the plot, things look much worse....
